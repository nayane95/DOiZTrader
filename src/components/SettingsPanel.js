  ...
  _createPanel() {
    ...
    this.panel.innerHTML = `
      ...
      <div class="settings-panel__content">
        ...
        <div class="settings-section">
          <h3 class="settings-section__title">Heatmap</h3>
          ...
          <div class="settings-row">
            ...
            <select id="setting-heatmap-levels">
              <option value="50" ${this.settings.heatmapLevels === 50 ? 'selected' : ''}>50 (coarse)</option>
              <option value="100" ${this.settings.heatmapLevels === 100 ? 'selected' : ''}>100 (balanced)</option>
              <option value="200" ${this.settings.heatmapLevels === 200 ? 'selected' : ''}>200 (fine)</option>
              <option value="300" ${this.settings.heatmapLevels === 300 ? 'selected' : ''}>300 (very fine)</option>
              <option value="500" ${this.settings.heatmapLevels === 500 ? 'selected' : ''}>500 (max)</option>
            </select>
          </div>
          
          <div class="settings-row">
            <label>Show Volumes</label>
            <input type="checkbox" id="setting-heatmap-labels" ${this.settings.heatmapShowLabels ? 'checked' : ''}>
          </div>
        </div>
        
        <div class="settings-section">
          <h3 class="settings-section__title">Order Book</h3>
          
          <div class="settings-row">
            <label>Depth</label>
            <select id="setting-orderbook-depth">
              <option value="5" ${this.settings.orderBookDepth === 5 ? 'selected' : ''}>5 levels</option>
              <option value="10" ${this.settings.orderBookDepth === 10 ? 'selected' : ''}>10 levels</option>
              <option value="20" ${this.settings.orderBookDepth === 20 ? 'selected' : ''}>20 levels</option>
              <option value="50" ${this.settings.orderBookDepth === 50 ? 'selected' : ''}>50 levels</option>
              <option value="100" ${this.settings.orderBookDepth === 100 ? 'selected' : ''}>100 levels</option>
            </select>
          </div>
        </div>
        
        <div class="settings-section">
          <h3 class="settings-section__title">Presets</h3>
