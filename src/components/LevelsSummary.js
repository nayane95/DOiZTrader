...
export class LevelsSummary {
    ...
    _init() {
      ...
      <div class="levels-summary__header">
        <span class="levels-summary__title">Key Levels</span>
      ...
      <div class="levels-summary__stats" id="levels-stats">
        ...
        <div class="levels-summary__stat">
          <span class="levels-summary__stat-label">Nearest Support</span>
          <span class="levels-summary__stat-value levels-summary__stat-value--bid" id="stat-support">—</span>
        </div>
        <div class="levels-summary__stat">
          <span class="levels-summary__stat-label">Nearest Resistance</span>
    ...
    `).join('') || '<div class="levels-summary__empty">No significant levels</div>';
    }
